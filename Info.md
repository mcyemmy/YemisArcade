...
- Data binding - Handles communication between the component and the view. Synchronize data between Model and View - two-way binding, property binding, event binding 
