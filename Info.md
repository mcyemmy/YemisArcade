...
- The angular CLI helps to manage the entire project from app installation to running the localhost server, build for dev (compiling Typescript to Javascript), build for prod (minify, uglify and bundles files through the included AOT compilation)
