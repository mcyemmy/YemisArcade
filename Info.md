...
- Typescript is preferred because it is easier to refactor for large projects, has better readability, is static/strongly typed and has class-inheritance not prototypical inheritance, has decorators (functions that modifies other functions without impacting the original code block).
